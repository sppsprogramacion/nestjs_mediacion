import { IsDateString, IsInt, IsString, Length, MaxLength } from "class-validator";
...
export class CreateAudienciaDto {
    ...
    @MaxLength(300,{message: "El detalle debe tener entre $constraint1 y $constraint2 caracteres."})
    detalles: string;
